...
A full list can be found on the https://gatling.io/docs/gatling/reference/current/core/assertions/[Assertions] page.
...
* https://gatling.io/docs/gatling/reference/current/core/configuration/[Conguration options]
